...
class DriveService:
    ...
    def download_file(self, file_id: str, file_name: str) -> Optional[str]:
        """Download a file to a local temporary path. Returns the path."""
        if not self.service:
            return None
