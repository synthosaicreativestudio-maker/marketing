...
- [Быстрая настройка Cloudflare Tunnel](getting-started/QUICK_START_CLOUDFLARE.md) — Настройка туннеля
...
- [Настройка Cloudflare Tunnel](deployment/CLOUDFLARE_TUNNEL_SETUP.md) — Подробная инструкция
