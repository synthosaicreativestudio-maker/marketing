...
Добро пожаловать в MarketingBot! Этот документ — ваш навигатор по системе, разделенный на функциональный и технический блоки.

> [!TIP]
> **🚀 Быстрый старт (За 30 секунд):**
> 1. Нажмите `/start` и введите ваш Код партнера.
> 2. Спросите Галину о чем угодно (например: "Где найти шаблон договора?").
> 3. Попробуйте «Аналитику 360» через меню для оценки любого объекта.
...
## 6. 💼 Сценарии успеха (Как это помогает в работе)

*   **Подготовка к встрече:** Введите код объекта в «Аналитику» за 2 минуты до встречи. У вас на руках будут все цифры рынка и готовый PDF для клиента.
*   **Срочный поиск:** Вместо того чтобы звонить коллегам, спросите Галину: "Какие условия по ипотеке в ЖК Радужный?". Она ответит за секунды.
*   **Контроль акций:** Бот сам напишет вам, когда стартует новая акция. Вам не нужно проверять почту или общие чаты.
...
## 8. 🛠 Техническая поддержка и Troubleshooting

Если что-то пошло не так, попробуйте эти шаги:

| Проблема | Решение |
| :--- | :--- |
| **Бот не отвечает** | Введите команду `/start`. Если не помогло — свяжитесь с поддержкой. |
| **Не приходит PDF-отчет** | Убедитесь, что ввели верный код объекта. Процесс может занимать до 2-х минут. |
| **Галина "путает" факты** | Попробуйте переформулировать вопрос. ИИ лучше понимает конкретику. |
| **Ошибка авторизации** | Проверьте номер телефона и код в Google Таблице (лист Auth). |
...
- **Защита данных:** Все данные хранятся на защищенных серверах Yandex Cloud и Google Cloud.
- **Приватность:** Бот не собирает ваши пароли или личные платежные данные.
- **Шифрование:** Общение с ИИ защищено протоколами Telegram.

---

## 10. 📚 Глоссарий терминов

- **RAG (Библиотекарь):** Технология, позволяющая ИИ искать ответы в ваших файлах, а не "выдумывать" их.
- **Gateway (Шлюз):** Устройство, которое следит, чтобы база данных не перегрузилась.
- **Circuit Breaker:** Автоматический выключатель, изолирующий сбойный модуль.
- **Blue-Green:** Метод обновления, при котором бот всегда остается доступным.
- **UseCase:** Реальный сценарий использования функции.
...
## 14. 🚀 Технология обновлений (Blue-Green Stability)
